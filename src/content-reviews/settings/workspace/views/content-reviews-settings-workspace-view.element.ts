...
{
  #workspaceContext?: typeof WORKFLOW_CONTENTREVIEWS_SETTINGS_WORKSPACE_CONTEXT.TYPE;
  ...
  #renderContentItemReviews() {
    ...
    >
      <div slot="headline">
        ${this.localize.term("workflow_contentReviews_contentItemReviews")}
        <small
          >${this.localize.term(
            "workflow_contentReviews_contentItemReviewsDescription"
          )}</small
        >
      </div>
  ...
  #renderDocumentTypeReviews() {
    ...
    >
      <div slot="headline">
        ${this.localize.term("workflow_contentReviews_documentTypeReviews")}
        <small
          >${this.localize.term(
            "workflow_contentReviews_documentTypeReviewsDescription"
          )}</small
        >
      </div>
      <workflow-content-reviews-config-list
        .type=${UMB_DOCUMENT_TYPE_ENTITY_TYPE}
      ></workflow-content-reviews-config-list>
    </uui-box>`;
  }
