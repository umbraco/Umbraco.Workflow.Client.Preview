...
const elementName = "workflow-instances-table-status-column-layout";

@customElement(elementName)
export class WorkflowInstancesTableStatusColumnLayoutElement extends UmbLitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    [elementName]: WorkflowInstancesTableStatusColumnLayoutElement;
  }
}
