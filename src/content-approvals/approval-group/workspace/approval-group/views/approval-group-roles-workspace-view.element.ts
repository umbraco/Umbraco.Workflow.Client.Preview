...
import { WORKFLOW_SETTINGS_ROOT_ENTITY_TYPE } from "@umbraco-workflow/settings";
  ...
  implements UmbWorkspaceViewElement
{
  ...
  async connectedCallback() {
    ...
    this._editDocumentPath = await firstValueFrom(
      new WorkflowWorkspaceModalRouterController(this, UMB_DOCUMENT_ENTITY_TYPE)
        .path
    );
    this._editDocumentTypePath = await firstValueFrom(
      new WorkflowWorkspaceModalRouterController(
        this,
