...
import { WORKFLOW_APPROVALGROUP_ITEM_STORE_CONTEXT } from "./approval-group-item.store.js";
...
export class WorkflowApprovalGroupItemRepository extends UmbItemRepositoryBase<ApprovalGroupItemModel> {
  constructor(host: UmbControllerHost) {
    super(
      host,
      WorkflowApprovalGroupItemServerDataSource,
      WORKFLOW_APPROVALGROUP_ITEM_STORE_CONTEXT
    );
  }
}
