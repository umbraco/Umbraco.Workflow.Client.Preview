...
export const WORKFLOW_APPROVAL_GROUPS_REPOSITORY_ALIAS = 'Umb.Repository.Workflow.ApprovalGroups';
export const WORKFLOW_APPROVAL_GROUPS_STORE_ALIAS = 'Umb.Store.Workflow.ApprovalGroups';
