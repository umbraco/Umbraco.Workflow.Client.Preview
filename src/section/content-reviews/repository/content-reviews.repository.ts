...
export class WorkflowContentReviewsRepository extends WorkflowRepositoryBase<ContentReviewsConfigModel, ContentReviewsSaveSettingsModel> {
  constructor(host: UmbControllerHost) {
    super(host, WorkflowContentReviewsServerDataSource, WORKFLOW_CONTENTREVIEWS_STORE_CONTEXT);
  }
}
