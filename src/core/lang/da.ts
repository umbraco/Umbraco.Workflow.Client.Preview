...
export default {
  ...
  workflow_permissions: {
    activeWorkflowsRead: `Tillad adgang til at se aktive workflows`,
    advancedSearchRead: `Tillad adgang til at se det avancerede søgedashboard`,
    approvalGroupRead: `Tillad adgang til at se godkendelsesgrupper`,
    approvalGroupCreate: `Tillad adgang til at oprette godkendelsesgrupper`,
    approvalGroupUpdate: `Tillad adgang til at opdatere godkendelsesgrupper`,
    configurationRead: `Tillad adgang til at se workflow konfiguration`,
    configurationUpdate: `Tillad adgang til at opdatere workflow konfiguration`,
    contentReviewRead: `Tillad adgang til at se indholdsanmeldelser`,
    documentInitiate: `Tillad initiering af workflows på dokumenter`,
    documentUnlock: `Tillad oplåsning af dokumenter`,
    historyRead: `Tillad adgang til at se workflow historik`,
  },
  workflow_property: {
    allowAttachments: "Tillad vedhæftede filer",
    lockIfActive: "Lås aktivt indhold",
  ...
  workflow_propertyDescription: {
    ...
    lockIfActive:
      "Angiver om en node kan redigeres mens den er i et aktivt workflow.",
    requireUnpublish: "Skal afpublicér kræver workflow godkendelse?",
    ...
    siteUrl:
      "site URL som bruges i email notifikationer (f.eks. http://www.mydomain.com)",
    email: "Afsender adresse for email notifikationer",
    editUrl:
      "Backoffice site URL som bruges i email notifikationer (f.eks. http://edit.mydomain.com)",
  },
