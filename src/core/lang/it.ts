...
export default {
  ...
  workflow_propertyDescription: {
    ...
    editUrl:
      "Modifica l'URL del sito per l'inclusione nelle notifiche email (es. http://edit.mydomain.com)",
    email: "Indirizzo FROM per notifiche email",
    extendPermissions:
      "Imposta su 'true' per estendere le autorizzazioni di salvataggio e pubblicazione predefinite degli utenti. Se falso, il pulsante Salva e pubblica viene rimosso",
    lockIfActive:
      "Imposta su 'true' per impedire modifiche mentre il contenuto si trova in un flusso di lavoro",
    ...
    scheduledContentLock:
      "Impostato su true per impedire modifiche mentre il contenuto è in attesa di pubblicazione pianificata",
    sendNotifications: "Imposta su 'true' per inviare notifiche email",
    siteUrl:
      "URL del sito attivo da includere nelle notifiche e-mail (es. http://www.mydomain.com)",
  ...
  workflow_permissions: {
    activeWorkflowsRead: `Consenti l'accesso per visualizzare i flussi di lavoro attivi`,
    advancedSearchRead: `Consenti l'accesso per visualizzare la dashboard di ricerca avanzata`,
    approvalGroupRead: `Consenti l'accesso per visualizzare i gruppi di approvazione`,
    approvalGroupCreate: `Consenti l'accesso per creare gruppi di approvazione`,
    approvalGroupUpdate: `Consenti l'accesso per aggiornare i gruppi di approvazione`,
    configurationRead: `Consenti l'accesso per visualizzare la configurazione del flusso di lavoro`,
    configurationUpdate: `Consenti l'accesso per aggiornare la configurazione del flusso di lavoro`,
    contentReviewRead: `Consenti l'accesso per visualizzare le revisioni dei contenuti`,
    documentInitiate: `Consenti l'avvio di flussi di lavoro sui documenti`,
    documentUnlock: `Consenti lo sblocco dei documenti`,
    historyRead: `Consenti l'accesso per visualizzare la cronologia del flusso di lavoro`,
  },
