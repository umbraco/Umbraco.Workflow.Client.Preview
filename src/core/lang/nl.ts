...
export default {
  workflow: {
    ...
    noDocumentFlow:
      "Geen document goedkeuringsflow ingesteld voor dit document",
...
Vergrendelde inhoud kan pas worden bewerkt als de geplande releasedatum is verstreken. Vergrendelingen kunnen worden vrijgegeven door Workflow-beheerders.</p><ul>
  ...
  workflow_search: {
    ...
    emptyFieldSearchDescription:
      "Het zoeken naar lege velden kan kostbaar zijn en langer duren dan verwacht",
  ...
  workflow_propertyDescription: {
    ...
    editUrl:
      "Site-URL bewerken voor weergave in e-mailmeldingen (bijv. http://edit.mydomain.com)",
    email: "VAN-adres voor e-mailmeldingen",
    extendPermissions:
      "Zet deze optie aan de standaard machtigingen voor opslaan en publiceren van gebruikers uit te breiden. Als deze optie uit staat, wordt de knop Opslaan en publiceren verwijderd",
    lockIfActive:
      "Zet deze optie aan om bewerkingen te voorkomen terwijl inhoud zich in een workflow bevindt",
    ...
    scheduledContentLock:
      "Stel deze in op true om bewerkingen te voorkomen terwijl de inhoud in afwachting is van geplande publicatie",
    sendNotifications: "Zet deze optie aan om e-mailmeldingen te verzenden",
    siteUrl:
      "Live site-URL voor opname in e-mailmeldingen (bijv. http://www.mijndomein.com)",
    ...
    reminderThreshold:
      "Beoordelingsmeldingen worden zoveel dagen voor de beoordelingsdatum verzonden. Standaard is 1",
    reviewPeriod: "Maximale tijdsperiode tussen vereiste inhoudsbeoordelingen",
  },
  user_permissionsEntityGroup: {
    workflow: "Workflow",
  },
  workflow_permissions: {
    activeWorkflowsRead: `Toegang toestaan om actieve workflows te bekijken`,
    advancedSearchRead: `Toegang toestaan om het geavanceerde zoekdashboard te bekijken`,
    approvalGroupRead: `Toegang toestaan om goedkeuringsgroepen te bekijken`,
    approvalGroupCreate: `Toegang toestaan om goedkeuringsgroepen te maken`,
    approvalGroupUpdate: `Toegang toestaan om goedkeuringsgroepen bij te werken`,
    configurationRead: `Toegang toestaan om workflowconfiguratie te bekijken`,
    configurationUpdate: `Toegang toestaan om workflowconfiguratie bij te werken`,
    contentReviewRead: `Toegang toestaan om inhoudsbeoordelingen te bekijken`,
    documentInitiate: `Toestaan om workflows op documenten te starten`,
    documentUnlock: `Toestaan om documenten te ontgrendelen`,
    historyRead: `Toegang toestaan om workflowgeschiedenis te bekijken`,
  },
