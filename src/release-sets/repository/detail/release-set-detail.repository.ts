...
import { type ReleaseSetDetailResponseModelReadable } from "@umbraco-workflow/generated";

export class WorkflowReleaseSetDetailRepository extends UmbDetailRepositoryBase<ReleaseSetDetailResponseModelReadable> {
